					...
					<div className='bg-white rounded-xl shadow-lg p-8 md:p-12'>
						...
						<form
							...
							<select
								name='department_id'
								required
								className='border-b border-gray-300 py-3 bg-transparent text-gray-800 focus:outline-none'>
							...
							<select
								...
								required
								className='border-b border-gray-300 py-3 bg-transparent text-gray-800 focus:outline-none'>
								<option value=''>القسم الموجه له الطلب</option>
							...
							<textarea
								...
								required
								rows={4}
								className='md:col-span-2 border-b border-gray-300 py-3 bg-transparent text-gray-800 placeholder-gray-400 focus:outline-none'></textarea>
