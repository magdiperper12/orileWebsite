...
const Demands = () => {
  ...
  return (
    <>
      <BreadCrumb title={t("Demands")} breadcrumbs={[{ name: t("Demands") }]} />
          ...
          <div className="bg-[#24403f] rounded-xl shadow-lg p-8 md:p-12">
            ...
            >
              ...
              <input
                ...
                required
                className="border-b border-gray-300 py-3 bg-transparent text-gray-100 placeholder-gray-400 focus:outline-none"
              />
              ...
              <div className="md:col-span-2 text-center mt-6">
                <button
                  type="submit"
                  className="px-8 py-3 text-white bg-[#B1946A] rounded-lg hover:bg-primary/90 transition"
                >
                  إرسال
                </button>
              </div>
